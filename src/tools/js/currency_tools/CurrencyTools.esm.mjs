...
export class CT {
  ...
  /*
   ...
   host       "localhost:8090"
   hostname       "localhost"
   href       "http://localhost:8090/web-for-vite-project-template/apps/localServer/pages/index.html"
   pathname       "/web-for-vite-project-template/apps/localServer/pages/index.html"
   port       "8090"
   protocol       "http:"
   search       ""
   ...
   *
   * 例子：<br />
   * 当前的URL：http://localhost:8090/web-for-vite-project-template/dist/dev_server/pages/Index.html<br /><br />
   *
   * 'something1?pageNumber=1': http://localhost:8090/web-for-vite-project-template/dist/dev_server/pages/something1?pageNumber=1<br />
   * '/something2?pageNumber=2': http://localhost:8090/something2?pageNumber=2<br />
   * '../something3?pageNumber=3': http://localhost:8090/web-for-vite-project-template/dist/dev_server/something3?pageNumber=3
   *
   ...
   * 格式是：http://localhost:8090/web-for-vite-project-template/app/devServer/pages/webProTpl.html<br /><br />
   *
