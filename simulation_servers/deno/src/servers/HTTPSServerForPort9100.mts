...
const HTTPSServerForPort9100: Deno.HttpServer<Deno.NetAddr> = Deno.serve(
  {
    port: 9100,
    /**
     * 用postman测试时：<br />
     ...
     * 3、当设置为'0.0.0.0'时，用如“https://localhost:9100”、“https://127.0.0.1:9100”、“https://192.168.2.7:9100”能连接上。<br />
     *
     * 用浏览器测试时：<br />
     * 1、当设置为'localhost'时，用如“https://localhost:9100”能连接上。<br />
     * 2、当设置为'127.0.0.1'时，用如“https://127.0.0.1:9100”、“https://localhost:9100”能连接上。<br />
...
export {
  HTTPSServerForPort9100,
};

export default HTTPSServerForPort9100;
