...
const WebSocketServerForPort9300: Deno.HttpServer<Deno.NetAddr> = Deno.serve(
  {
    port: 9300,
    /**
     * 用postman测试时：<br />
     ...
     * 3、当设置为'0.0.0.0'时，用如“ws://localhost:9300”、“ws://127.0.0.1:9300”、“ws://192.168.2.7:9300”能连接上。<br />
     *
     * 用浏览器测试时：<br />
     * 1、当设置为'localhost'时，用如“ws://localhost:9300”能连接上。<br />
     * 2、当设置为'127.0.0.1'时，用如“ws://127.0.0.1:9300”、“ws://localhost:9300”能连接上。<br />
    ...
    onListen: (
      ...
      MyConsole.Cyan( `
来自：simulation_servers/deno/src/servers/WebSocketServerForPort9300.mts
WebSocket Server已启动（Windows系统上无法直接访问“0.0.0.0”，请改用本地、局域网IP等等，支持IPV4、IPV6）：ws://${ hostname }:${ port }/。
` );
...
` );
    ...
    logWriteStream.write( `
来自：simulation_servers/deno/src/servers/WebSocketServerForPort9300.mts
WebSocket Server info--->Start

${ JSON.stringify( info, null, 4 ) }

WebSocket Server info--->End
` );
...
export {
  WebSocketServerForPort9300,
};

export default WebSocketServerForPort9300;
