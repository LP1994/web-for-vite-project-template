 ...
 * FileDirPath: simulation_servers/deno/src/services/jsonp_service/Condition.esm.mts
 * Author: 12278
...
// 符合处理条件的请求URL核心标头，如：https://127.0.0.1:9200/simulation_servers_deno/jsonp?callBack=JSONPCallBack&name=林沐风&age=12#personal_information
export const myURLPathName: string = `/simulation_servers_deno/jsonp`;
