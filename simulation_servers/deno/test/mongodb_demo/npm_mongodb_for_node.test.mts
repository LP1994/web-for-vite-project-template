 ...
 * FileDirPath: simulation_servers/deno/test/mongodb_demo/npm_mongodb_for_node.test.mts
 * Author: 12278
...
async function run(): Promise<void>{
  try{
    const database: T_Db = client.db( 'local' ),
      ...
      startup_log: Array<I_StartupLogCollectionSchema> = await ( startup_log_collection.find<I_StartupLogCollectionSchema>() ).toArray();
